<template >
    <table class="m-auto mt-10 bg-[#f9fafb] w-5/6">
        <tr>
            ...
            <td @click="nextMonth" class="p-2 text-right"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="relative inline-block cursor-pointer w-6 h-6 mr-6">
